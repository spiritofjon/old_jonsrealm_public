...
// This script creates random bouncing balls
// <!--Bouncing Balls 1--><script language=JavaScript src="../scripts/balls1.js" type="text/javascript"></script>
// <!--Bouncing Balls 2--><script language=JavaScript src="../scripts/balls2.js" type="text/javascript"></script>

// Then insert the code below into the actual <body> tag
// onLoad="javascript:loadBouncingImages();"
...
bouncingImages.imgSrc = 'backgrounds/ball.gif';

bouncingImages.frameRate = 30;

bouncingImages.minRandomSpeed = 2;
bouncingImages.maxRandomSpeed = 6;
